"""
Plot accuracy and loss curves for different number of clients
"""
import json
...
print('Chart saved: experiment1_client_numbers.png')
...
for name, history in [('5 Clients', history_5), ('10 Clients', history_10), ('20 Clients', history_20)]:
    ...
    print(f'{name}: Max Accuracy={max_acc:.2f}%, Final Accuracy={final_acc:.2f}%')
